  ...
  const { name, age, grade, gender, fieldOfStudy, clubsAndOrganizations} = req.body;
    ...
    switch (fieldOfStudy) {
       ...
       case 'Computer Engineering (BSCPE)':
        ...
        if(grade == 2027)
        {
            courses = "Important courses to take over your next four years: ENGE 1215, PHYS 2305, ENGE 1216, PHYS 2306, ME 2004, ME 2134, ECE 2054, ME 3024, ME 3414, ME 3524, ME 3624, ME 3304, ME 3534, ME 4005, ."
        }
        else if(grade == 2026)
        {
            courses = "Important courses to take over your next three years: PHYS 2306, ME 2004, ME 2134, ECE 2054, ME 3024, ME 3414, ME 3524, ME 3624, ME 3304, ME 3534, ME 4005, ."
        }
        else if(grade ==2025)
        {
            courses = "Important courses to take over your next two years: ME 3024, ME 3414, ME 3524, ME 3624, ME 3304, ME 3534, ME 4005, ."
        }
        else if(grade == 2024)
        {
            courses  = "Since you finished the core mateiral, some electives we recommend are: ME 4454 and ME 3984"
        }
        else
        {
            courses = "For you we recommend looking into a Masters Program, they have some great classes for students like you to take."
