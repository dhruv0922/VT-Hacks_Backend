...
function App() {
  ...
  return (
    ...
    <div>
     <section className="cover-page">
       <div className="cover-content">
         ...
         <div className="cover-description">
           <h1 className="title1">Roadmap to Success</h1>
           <p className="description">
           "Welcome to Roadmap to Success, your ultimate destination
           for charting a course to a thriving future! At Roadmap to
           Success, we're dedicated to empowering students to shape their
           career paths with precision. Our comprehensive approach takes
           into account your academic achievements, unique experiences,
           valuable expertise, and educational pursuits. Through our
           cutting-edge platform, we offer personalized and actionable
           recommendations that encompass not only clubs and organizations
           but also coveted internships and thoughtfully curated courses.
           Join us today, and let's embark on a transformative journey
           towards unlocking your full potential, achieving your dreams,
           and maximizing your future success!"
     ...
     <div ref={containerRef} className="career-roadmap-container">
       <header className="career-roadmap-header">
         <img src="vt.png" alt="" className="logo" />
         <h1 className="title2">Start Your Roadmap Below!</h1>
       </header>
